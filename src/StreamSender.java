...
public class StreamSender extends JFrame implements ActionListener {
    ...
    //Constructor
    //--------------------------
    public StreamSender(String videoFileName, String ipNode, int portaStream) {
        //init Frame
        super("StreamSender");

        RTP_dest_port = portaStream;
